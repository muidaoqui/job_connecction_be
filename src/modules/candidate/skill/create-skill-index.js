// d:\job-connection\job_connecction_be\src\modules\candidate\embedding\create-skill-index.js
...
async function run() {
    ...
    try {
        ...
        console.log("Creating vector search index for skills...");
        
        // Create the search index
        const result = await collection.createSearchIndex(indexDefinition);
        
        console.log("Skill vector search index created successfully!");
