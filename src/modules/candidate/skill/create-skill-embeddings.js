// d:\job-connection\job_connecction_be\src\modules\candidate\embedding\create-skill-embeddings.js
...
async function run() {
    ...
    try {
        ...
        console.log(`Found ${documents.length} skill documents to process`);
        ...
        await Promise.all(documents.map(async doc => {
            try {
                ...
                console.error(`Error processing skill ${doc._id}:`, err.message);
            }
        }));
        ...
        if (updateDocuments.length > 0) {
            ...
            console.log("Skill embeddings created: " + result.modifiedCount); 
        } else {
